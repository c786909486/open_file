...
import com.crazecoder.openfile.utils.InstallAppUtils;
...
public class OpenFilePlugin implements MethodCallHandler
    ...
    public void onMethodCall(MethodCall call, @NonNull Result result) {
        ...
        if (call.method.equals("open_file")) {
            ...
            if (TYPE_STRING_APK.equals(typeString)&&filePath.contains(context.getExternalFilesDir(null).getAbsolutePath())) {
                InstallAppUtils.INSTANCE.installApp(context,new File(filePath));
            }else {
